...
const Navbar = () => {
  ...
  return (
    ...
    <div className="bg-white shadow z-40 relative">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 flex items-center justify-end">
            <div className='hidden lg:block mx-6'>
              <div className={componentsStyle.searchDiv}>
                <input className={`${componentsStyle.textBox} border-0`} type="search" name="search" placeholder="Keyword..." aria-label="Keyword..." />
                <button className={`${componentsStyle.btnPrimary} h-full`}>search</button>
              </div>
            </div>
            ...
            <div className='relative inline-block' onClick={() => { setActiveDrop(!activeDrop) }}>
              ...
              <button className={navBarStyle.dropDownBtn}>
                <div className='grid place-items-center h-full mr-2'>
              ...
              <div className={`${navBarStyle.dropDownMenu} ${!activeDrop ? 'hidden' : ''} right-0 `}>

                <a href="#" className={navBarStyle.anchorDropDown}>
